...
#             "selectable_persistence": False,
        ...
        self.columns_dropdown.items = [col["field"] for col in self.tabulator_obj.columns[1:-1]]
        self.fields_dropdown.items = [col["field"] for col in self.tabulator_obj.columns[1:-1]]
